...
function Dropdown(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(DropdownContext.Provider, {
    value: contextValue,
    children
  });
}
true ? Dropdown.propTypes = {
   ...
   */
  onOpenChange: import_prop_types2.default.func,
  /**
...
var TextareaAutosize = React10.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const renders = React10.useRef(0);
  const [state, setState] = React10.useState({
    outerHeightStyle: 0
  });
  const getUpdatedState = React10.useCallback(() => {
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-UR3IS2IW.js.map
